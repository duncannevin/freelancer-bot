        ...
        apiHandler.deleteBids(quote.posted_id, err => {
          ...
          apiHandler.deletePost(quote.posted_id, err => {
            ...
            state.deleteChat(this.userState.chatId, err => {
              ...
              const replyMsg = `
                ${quote.description} - has been awarded to ${quote.username}. To update the status of this job/product go to 'Check your awarded'.
              `;
  ...
  filterConfirm() {
    switch(this.msg.body) {
      ...
      case 'Nevermind':
        ...
        break;
      default:
        this.sendMsg(`I don't understand`, ['Award it!', 'Nevermind'], this.msg.from);
        break;
    }
  }
