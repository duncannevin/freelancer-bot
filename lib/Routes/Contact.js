...
export default class extends Main {
        ...
        apiHandler.getPost(this.userState.postShowing, (err, data) => {
          ...
          apiHandler.postBid({username: user.username, price: subStageData.price, posted_id: post.posted_id}, (err) => {
            ...
            state.deleteChat(this.userState.chatId, err => {
              ...
              this.sendMsg(posterMsg, masterStages, post.username);
  ...
  quoteLooksBad() {
    state.deleteChat(this.userState.chatId, err => {
      ...
      this.sendMsg('No problem', masterStages, this.msg.from);
    })
  }
      ...
      case 2:
        switch(this.msg.body) {
          ...
          case 'Let me rethink that':
            ...
            break;
          default:
            this.sendMsg(`Sorry I didn't catch that`, ['Perfect!', 'Let me rethink that', 'Main menu'], this.msg.from);
          return;
        }
        break;
      default:
        this.sendMsg(`Sorry I didn't catch that`, skills, this.msg.from);
        return;
    }
  }
