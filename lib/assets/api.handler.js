...
const API = process.env.API_URL || 'https://gig-api.herokuapp.com/api';
const API_KEY = process.env.API_KEY || 'P4VvNhswLY';
const APP_ID = process.env.APP_ID || 'gigfnut7kb6j5o';
