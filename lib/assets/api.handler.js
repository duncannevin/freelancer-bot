...
const API = process.env.GIG_API_URL || 'http://localhost:3000/api';
const API_KEY = process.env.GIG_API_KEY || 'P4VvNhswLY'; //<<read above
const APP_ID = process.env.GIG_APP_ID || 'gigdt4l97v0qksyixfr2rly'; //<<read above
